...
function generalSystemPrompt(input: {
  ...
  return [
    ...
    "",
    "ACCURACY — never invent data. Do NOT fabricate category, team, user, service or asset names. BEFORE",
    "you set a category or route to a team in a proposal, CALL the matching read tool (category_list,",
    "group_list, or the search tools) and use one of the REAL returned names verbatim. If nothing fits, or",
    "you can't verify it, LEAVE THE FIELD UNSET rather than guessing. If you don't know something, say so",
    "or look it up; do not present a guess as fact.",
    "",
