...
function generalSystemPrompt(input: {
  ...
  return [
    ...
    "and create categories, tags, services, assets, locations, and more. Refer to teams / categories",
...
function adminSystemPrompt(input: {
  ...
  return [
    ...
    "tags, groups/teams, services, catalog items, assets, locations, SLAs, knowledge articles,",
